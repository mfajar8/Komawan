    ...
    class Pasien extends MY_Controller
    {
        ...
        {$datapasien=$this->Pasien_model->get_all();//panggil ke modell
          $datafield=$this->Pasien_model->get_field();//panggil ke modell
           ...
           $data = array(
             'content'=>'pasien/pasien/pasien_list',
             'sidebar'=>'pasien/sidebar',
             'css'=>'pasien/pasien/css',
             'js'=>'pasien/pasien/js',
        ...
        public function ajax_list()
      {
        ...
        public function create(){
           $data = array(
             'content'=>'pasien/pasien/pasien_create',
             'sidebar'=>'pasien/sidebar',
             'action'=>'pasien/pasien/create_action',
             'module'=>'pasien',
             'titlePage'=>'pasien',
             'controller'=>'pasien'
            );
        ...
        public function edit($id_pasien){
          $dataedit=$this->Pasien_model->get_by_id($id_pasien);
           $data = array(
             'content'=>'pasien/pasien/pasien_edit',
             'sidebar'=>'pasien/sidebar',
             'action'=>'pasien/pasien/update_action',
             'dataedit'=>$dataedit,
             'module'=>'pasien',
             'titlePage'=>'pasien',
             'controller'=>'pasien'
